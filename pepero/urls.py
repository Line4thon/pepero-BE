...
from .views import pepero_make_choco_view, pepero_make_letter_view, pepero_make_deco_view,pepero_make_sauce_view,pepero_make_start_view,pepero_make_home_view,pepero_make_end_view,pepero_make_ing_view
